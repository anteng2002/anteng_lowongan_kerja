...
@section('content')
    ...
    <div class="container mt-5">
        <h1 class="text-center mb-4 text-primary">Kontak Lowongan Kerja</h1>
        <p class="text-center mb-5">Kami senang mendengar pengalaman dan pertanyaan Anda! Silakan tinggalkan pesan atau pertanyaan mengenai lowongan kerja yang kami tawarkan di sini.</p>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title" id="addContactModalLabel">Tambah Kontak Lowongan Kerja</h5>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-warning text-white">
                    <h5 class="modal-title" id="editContactModalLabel">Edit Kontak Lowongan Kerja</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
